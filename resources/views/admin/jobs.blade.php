        ...
        <div class="row align-items-center">
            ...
            <div class="col-7">
                <div class="text-left upgrade-btn">
                    <a href="{{url('dashboard/jobs/create')}}" class="btn btn-primary text-white">
                        <i class="mdi mdi-account-plus"></i>اضافة فرصة عمل
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">ادارة الوظائف</h4>
                                        ...
                                        <td>
                                            <div class="d-flex flex-row">
                                                <a class="btn btn-info mx-1"
                                                   href="{{url('dashboard/jobs/' . $item->id . '/edit')}}">
                                                    <i class="mdi mdi-account-edit "></i>
                                                </a>
                                                <form id="delete-form{{$item->id }}"
                                                      action="{{url('dashboard/jobs/' . $item->id)}}" method="POST">
                                                    @csrf()
                                                    @method('DELETE')
                                                </form>
