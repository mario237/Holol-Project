...
@foreach($_errors as $error)
    ...
    <div class="alert alert-danger alert-dismissible  m-0" role="alert" style="position: relative;">
        {{$error}}
...
@foreach($_successes as $success)
    ...
    <div class="alert alert-success alert-dismissible  m-0" role="alert" style="position: relative;">
        {{$success}}
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
