...
@section('main_content')
    ...
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            <div class="col-5">
                <h4 class="page-title">طلبات الحلول البرمجية</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('dashboard')}}">اللوحة</a></li>
                            <li class="breadcrumb-item active" aria-current="page">طلبات الحلول البرمجية</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">ادارة طلبات الحلول البرمجية</h4>
                                            ...
                                            <div class="d-flex flex-row">
                                                @if(in_array(\Illuminate\Support\Facades\Auth::user()->type,['3','4']))
                                                    <form id="delete-form{{$item->id }}"
                                                          action="{{url('dashboard/orders/programming/' . $item->id)}}"
                                                          method="POST">
                                                        @csrf()
                                                        @method('DELETE')
                                                    </form>
