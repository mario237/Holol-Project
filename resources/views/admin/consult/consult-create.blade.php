                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">اضافة استفسار</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <form action="{{$helper['action']}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row my-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control {{ $errors->get('name') ? 'is-invalid' : '' }}"
                                           id="name" placeholder="ادخل الاسم" name="name" value="{{old('name')}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row my-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control {{ $errors->get('mobile') ? 'is-invalid' : '' }}"
                                           id="mobile" placeholder="ادخل رقم الجوال" name="mobile" value="{{old('mobile')}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row my-3">
                                <div class="w-100 d-flex justify-content-between ">
                                    ...
                                    <button type="submit" class="btn btn-primary">اضافة استفسار</button>
                                </div>
                            </div>
                        </form>
                    </div>
