...
@section('main_content')
    ...
    <div class="hero inner" >
        <div class="intro">
            <h1 data-aos="fade-up" data-aos-delay=""> استعادة كلمة المرور</h1>
        ...
        <div class="container">
            <div class="row justify-content-md-center">
                <div class="col-lg-6 text-center">
                    ...
                    <form class="contact-form" data-aos="fade-up" method="POST" action="{{url('forget')}}">
                        @csrf
                        <div class="feature-1  text-center py-5">
                            <div class="row">

                                <div class="form-group col-md-12">
                                    <h3 class="text-black p-2" for="email">الرجاء ادخل بريدك الالكتروني الذي قمت بتسجيل حسابك من خلاله وسنقوم بارسال تفاصيل استعادة كلمة المرور اليك</h3>
                                    <h5 class="text-black p-2" for="email">ادخل بريدك الالكترني </h5>
                                    <input type="text" class="form-control text-center" id="email" name="email" required>
                                </div>
